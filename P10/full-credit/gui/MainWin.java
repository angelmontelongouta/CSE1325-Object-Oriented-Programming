...
public class MainWin extends JFrame {
    ...
    public MainWin(String title) {
       ...
       JButton bNew = new JButton(new ImageIcon("gui/resources/file_new.png"));
        ...
        JButton bOrder = new JButton(new ImageIcon("gui/resources/order.png"));
          bOrder.setActionCommand("Create new Order");
          bOrder.setToolTipText("Create new Order");
          toolbar.add(bOrder);
        ...
        JButton bServer = new JButton(new ImageIcon("gui/resources/server.png"));
        ...
        JButton bOrderList = new JButton(new ImageIcon("gui/resources/orderlist.png"));
          bOrderList.setActionCommand("List Orders");
          bOrderList.setToolTipText("List Orders");
          toolbar.add(bOrderList);
          bOrderList.addActionListener(event -> updateDisplayOrder());
	...
	protected void onCreateOrderClick() {
		...
		JLabel server = new JLabel("<HTML><BR/>Server</HTML>");
    ...
    protected void onCreateJavaClick() {  // Create a new Java product
		try {
            ...
            JSpinner dPrice = new JSpinner(new SpinnerNumberModel(0.00, 0.0, 99.99, 0.05));

            // Cost
            JLabel lCost = new JLabel("<HTML><BR/>Cost</HTML>");
            JSpinner dCost = new JSpinner(new SpinnerNumberModel(0.00, 0.0, 99.99, 0.05));
	...
	protected void onCreateServerClick() {
			JLabel name = new JLabel("<HTML><br/>Name</HTML>");
			names2 = new JTextField(30); 
			JLabel phone = new JLabel("<HTML><br/>Phone (Example 123-456-7890)</HTML>");
			phones2 = new JTextField(30);
			JLabel ssn = new JLabel("<HTML><br/>SSN (Example 123-45-7890)</HTML>");
			ssns = new JTextField(30);
			Object[] objects = {  // Array of widgets to display
	            name,   names2, 
	            phone,	phones2,
				ssn, ssns};
			int button = JOptionPane.showConfirmDialog( // Show the dialog
	            ...
	            JOptionPane.QUESTION_MESSAGE);
			if( button == JOptionPane.OK_OPTION){
			store.addPerson(new Server(names2.getText(), phones2.getText(), ssns.getText()));
			updateDisplayCusto();}
	}
    ...
    protected void onAboutClick() {                 // Display About dialog
       ...
       JLabel artists = new JLabel("<html>"
          ...
          + "<p>Server icon made by Freepik</p>"
          + "<p><font size=-2>https://www.freepik.com/person-213411</p>"   
          + "<p>Order icon made by Freepik</p>"
          + "<p><font size=-2>https://www.freepik.com/coffeedonut-2123121</p>"    
          + "<p>OrderList icon made by Freepik</p>"
          + "<p><font size=-2>https://www.freepik.com/people-clipart-78974</p>"  
          + "<br/>"
          + "</html>");
	...
	private JTextField names, names2;
	private JTextField phones, phones2, ssns;
	private JTextField nameDonuts;
	private JSpinner prices;
	private JSpinner costs;
	private JComboBox frostings;
